...
import type { InsomniaV5ImportPreview } from "./insomniaV5Types.ts";

type InsomniaImportDialogProps = {
    fileName: string;
...
export default function InsomniaImportDialog({
    fileName,
    collectionName,
    preview,
    warnings,
    ...
    return (
        ...
        >
            ...
            >
                <h3 style={{ margin: 0 }}>Import Insomnia V5</h3>
                <div style={{ fontSize: 13, color: "var(--pg-text-dim)", lineHeight: 1.5 }}>
                    Review the detected collection before importing.
                </div>
                <div
                    style={{
                        display: "grid",
                ...
                >
                    ...
                    <span style={{ color: "var(--pg-text-muted)" }}>Schema version</span>
                    <span>{preview.schemaVersion ?? "-"}</span>
