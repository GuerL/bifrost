...
import { buildAutoGeneratedHeadersPreview } from "./helpers/requestHeadersPreview.ts";
import {
...
export default function App() {
    ...
    const autoGeneratedHeaderPreviewRows = useMemo(() => {
        if (!draft) return [];
        return buildAutoGeneratedHeadersPreview({
            request: draft,
                                ...
                                <div style={{ display: "grid", gap: 10 }}>
                                    ...
                                    >
                                        ...
                                        <div style={{ display: "grid", gap: 6 }}>
                                            {autoGeneratedHeaderPreviewRows.map((row) => (
                                                <div
                                                    key={row.key}
                                                    style={{
                                                        display: "grid",
                                                        gridTemplateColumns: "minmax(140px, 210px) minmax(0, 1fr) auto",
                                                        gap: 8,
                                                        alignItems: "center",
                                                    }}
                                                >
                                                    ...
                                                    <span
                                                        ...
                                                        title={row.note}
                                                    >
                                                        {row.source === "user" ? "User" : "Auto"}
                                                    </span>
                                                </div>
                                            ))}
                                        </div>
                                        <div style={{ fontSize: 11, color: "var(--pg-text-muted)" }}>
                                            Preview only. These values are generated at send time by Bifrost/reqwest.
                                        </div>
                                    </div>
                                </div>
                            )}
